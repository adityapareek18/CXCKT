...
var SessionService = (function () {
    function SessionService(http) {
        ...
        this.sessionsUrl = 'api/sessions'; // URL to web api
    }
    ...
    SessionService.prototype.create = function (name) {
        return this.http
    ...
    SessionService.prototype.update = function (session) {
        var url = this.sessionsUrl + "/" + session.id;
        return this.http
